					...
					'fields' => array(
							...
							array(
			                    ...
			                    array(
			                        ...
			                        'desc'		=> esc_html__('Write 0 for free. You can define price sign and currency on Paypal Settings.', 'pointfindert2d'),
			                        'default'   => '5',
			                        'min'       => '0',
			                        'step'      => '1',
			                        'max'       => '10000000',
				...
				$this->sections[] = array(
					...
					'fields' => array(
		                    ...
		                    array(
		                        ...
		                        'type'      => 'text',
		                        'title'     => esc_html__('Paypal Price Sign', 'pointfindert2d'),
		                        'default'	=> '$',
		                        'required' => array('setup20_paypalsettings_paypal_status','=','1')
		                    ),
							array(
